...
if ( ! class_exists( 'WPGraphiQL' ) ) :
	...
	class WPGraphiQL {
		...
		/**
		 * Initializes WPGraphiQL constants and add WPGraphiQL actions
		 */
		...
		/**
		 * Checks if WPGraphQL is installed and active
		 */
		...
		/**
		 * Registers WPGraphiQL admin page
		 */
		...
		/**
		 * Returns path to asset manifest json
		 */
